...
```swift
dependencies: [
    .package(url: "https://github.com/devdasx/swift-bip39-mnemonic.git", from: "1.1.1")
]
```
...
pip install git+https://github.com/devdasx/swift-bip39-mnemonic.git@1.1.1
go get github.com/devdasx/swift-bip39-mnemonic/go/bip39@v1.1.1
cargo add --git https://github.com/devdasx/swift-bip39-mnemonic --tag 1.1.1 swiftbip39
```
